select * from customer; # Verification
...
group by shipping_type order by 'Average Amount'  asc;
...
#9. Are customers who are repeat buyers (more than 5 previous purchases) also likely to subscribe? (No subscription is not attractive)
SELECT subscription_status,
